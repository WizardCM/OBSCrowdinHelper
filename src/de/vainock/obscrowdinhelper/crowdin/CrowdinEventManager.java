...
public class CrowdinEventManager {
  ...
  /**
   * Registers a {@link CrowdinRequestFinishedEvent} which is going to be triggered when a
   * {@link CrowdinRequest} sent with {@link CrowdinRequest#sendWithTrigger()} finishes.
   * 
   * @author Vainock
  ...
  /**
   * Unregisters a {@link CrowdinRequestFinishedEvent} to be no longer triggered when a
   * {@link CrowdinRequest} sent with {@link CrowdinRequest#sendWithTrigger()} finishes.
   * 
   * @author Vainock
   * @param event - A {@link CrowdinRequestFinishedEvent}.
  ...
  /**
   * Returns the {@link CrowdinEventManager} intance which allows the registration of
   * {@link CrowdinRequestFinishedEvent}s
   * 
   * @author Vainock
